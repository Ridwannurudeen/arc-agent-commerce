...
export const CONTRACTS = {
  ...
  PIPELINE_ORCHESTRATOR: (process.env.NEXT_PUBLIC_PIPELINE_ORCHESTRATOR ?? "0x276F9CDD64f82362185Bc6FC715846A19B0f7Dd7") as `0x${string}`,
  COMMERCE_HOOK: (process.env.NEXT_PUBLIC_COMMERCE_HOOK ?? "0x792170848bEcFf0B90c5095E58c08F35F5efB72c") as `0x${string}`,
  // ERC-8183 (Arc native)
